...
import { sampleWithRequiredData } from '../material-inventory.test-samples';
...
describe('MaterialInventory Management Component', () => {
  let comp: MaterialInventoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MaterialInventoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.materialInventories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to materialInventoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaterialInventoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaterialInventoryIdentifier).toHaveBeenCalledWith(entity);
