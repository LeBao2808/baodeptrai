...
import { sampleWithRequiredData } from '../quantification.test-samples';
...
describe('Quantification Management Component', () => {
  let comp: QuantificationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(QuantificationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.quantifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to quantificationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getQuantificationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getQuantificationIdentifier).toHaveBeenCalledWith(entity);
