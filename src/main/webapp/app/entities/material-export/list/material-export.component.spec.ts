...
import { sampleWithRequiredData } from '../material-export.test-samples';
...
describe('MaterialExport Management Component', () => {
  let comp: MaterialExportComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MaterialExportComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.materialExports?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to materialExportService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaterialExportIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaterialExportIdentifier).toHaveBeenCalledWith(entity);
