...
import { sampleWithRequiredData } from '../product-receipt.test-samples';
...
describe('ProductReceipt Management Component', () => {
  let comp: ProductReceiptComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProductReceiptComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productReceipts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productReceiptService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductReceiptIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductReceiptIdentifier).toHaveBeenCalledWith(entity);
