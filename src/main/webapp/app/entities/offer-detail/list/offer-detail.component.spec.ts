...
import { sampleWithRequiredData } from '../offer-detail.test-samples';
import { OfferDetailService } from '../service/offer-detail.service';

import { OfferDetailComponent } from './offer-detail.component';
import SpyInstance = jest.SpyInstance;

describe('OfferDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.offerDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to offerDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOfferDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOfferDetailIdentifier).toHaveBeenCalledWith(entity);
