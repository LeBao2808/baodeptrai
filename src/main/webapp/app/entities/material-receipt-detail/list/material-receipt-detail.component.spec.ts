...
import { sampleWithRequiredData } from '../material-receipt-detail.test-samples';
...
describe('MaterialReceiptDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.materialReceiptDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to materialReceiptDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaterialReceiptDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaterialReceiptDetailIdentifier).toHaveBeenCalledWith(entity);
