...
describe('ProductionSite Management Component', () => {
  let comp: ProductionSiteComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ProductionSiteComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(ProductionSiteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productionSites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productionSiteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductionSiteIdentifier');
