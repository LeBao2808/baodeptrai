...
import { sampleWithRequiredData } from '../product-order-detail.test-samples';
...
describe('ProductOrderDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productOrderDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productOrderDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductOrderDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductOrderDetailIdentifier).toHaveBeenCalledWith(entity);
