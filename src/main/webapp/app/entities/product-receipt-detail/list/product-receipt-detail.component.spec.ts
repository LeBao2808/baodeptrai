...
import { sampleWithRequiredData } from '../product-receipt-detail.test-samples';
...
describe('ProductReceiptDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productReceiptDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to productReceiptDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProductReceiptDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProductReceiptDetailIdentifier).toHaveBeenCalledWith(entity);
