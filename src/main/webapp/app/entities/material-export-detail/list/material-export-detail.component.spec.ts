...
import { sampleWithRequiredData } from '../material-export-detail.test-samples';
...
describe('MaterialExportDetail Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.materialExportDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to materialExportDetailService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaterialExportDetailIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaterialExportDetailIdentifier).toHaveBeenCalledWith(entity);
