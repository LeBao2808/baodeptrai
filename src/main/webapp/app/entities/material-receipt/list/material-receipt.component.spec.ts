...
import { sampleWithRequiredData } from '../material-receipt.test-samples';
...
describe('MaterialReceipt Management Component', () => {
  let comp: MaterialReceiptComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [MaterialReceiptComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(MaterialReceiptComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.materialReceipts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to materialReceiptService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMaterialReceiptIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMaterialReceiptIdentifier).toHaveBeenCalledWith(entity);
