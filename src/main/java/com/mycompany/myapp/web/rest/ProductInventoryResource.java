...
public class ProductInventoryResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(ProductInventoryResource.class);
    ...
    public ResponseEntity<ProductInventoryDTO> createProductInventory(@RequestBody ProductInventoryDTO productInventoryDTO)
        ...
        productInventoryDTO = productInventoryService.save(productInventoryDTO);
        return ResponseEntity.created(new URI("/api/product-inventories/" + productInventoryDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, productInventoryDTO.getId().toString()))
            .body(productInventoryDTO);
    }
    ...
    public ResponseEntity<ProductInventoryDTO> updateProductInventory(
        ...
        productInventoryDTO = productInventoryService.update(productInventoryDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ProductInventoryDTO> getProductInventory(@PathVariable("id") Long id) {
