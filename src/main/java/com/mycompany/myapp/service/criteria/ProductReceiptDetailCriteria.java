...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.ProductReceiptDetail} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.ProductReceiptDetailResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-receipt-details?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ProductReceiptDetailCriteria implements Serializable, Criteria {
    ...
    public ProductReceiptDetailCriteria() {}

    public ProductReceiptDetailCriteria(ProductReceiptDetailCriteria other) {
    ...
    @Override
    public ProductReceiptDetailCriteria copy() {
        return new ProductReceiptDetailCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductReceiptDetailCriteria that = (ProductReceiptDetailCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, note, quantity, productId, receiptId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ProductReceiptDetailCriteria{" +
