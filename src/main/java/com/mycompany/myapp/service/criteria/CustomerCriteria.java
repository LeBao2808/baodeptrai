...
public class CustomerCriteria implements Serializable, Criteria {
    ...
    public CustomerCriteria(CustomerCriteria other) {
        ...
        this.type = other.optionalType().map(LongFilter::copy).orElse(null);
    ...
    public Optional<LongFilter> optionalType() {
        return Optional.ofNullable(type);
    }

    public LongFilter type() {
        if (type == null) {
            setType(new LongFilter());
        }
        return type;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, address, phone, email, type, distinct);
    }
